...
const { register, login, getUserWithDetails, getUserWithProgress, updateStudentCurrentPhase, updateStudentCurrentWeek, updateStudentCurrentDay, updateCoins } = require("../controller/studentController");
